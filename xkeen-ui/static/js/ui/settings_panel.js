    ...
    },
    {
      ...
      items: [
        ...
        createServerSwitch(
          ...
          'Подсвечивает в карточке Прокси последний выбранный Xray outbound по access/error логам. По умолчанию выключено, потому что требует включённых логов Xray.',
          'Отображение активного сервера сохранено.'
        ),
      ],
    },
    {
