    ...
    *,
    ...
    def index():
        ...
        page_ctx = {
            ...
            "xkeen_terminal_enable_ligatures": str(os.environ.get("XKEEN_ENABLE_XTERM_LIGATURES", "")).strip().lower() in {"1", "true", "yes", "on"},
            "xkeen_terminal_enable_webgl": str(os.environ.get("XKEEN_ENABLE_XTERM_WEBGL", "")).strip().lower() in {"1", "true", "yes", "on"},
