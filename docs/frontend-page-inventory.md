...
|---|---|---|---|---|---|
| `panel` | `/` | `templates/panel.html` | `static/js/pages/panel.entry.js` | `static/js/pages/panel.init.js` | Главная страница. Имеет shared runtime и split bundles для routing и Mihomo; template публикует только canonical `window.XKeen.pageConfig`. |
...
| `devtools` | `/devtools` | `templates/devtools.html` | `static/js/pages/devtools.entry.js` | `static/js/pages/devtools.init.js` | ESM bootstrap c прямыми feature imports; template публикует только canonical `window.XKeen.pageConfig`. |
...
| `mihomo_generator` | `/mihomo_generator` | `templates/mihomo_generator.html` | `static/js/pages/mihomo_generator.entry.js` | `static/js/pages/mihomo_generator.init.js` | ESM bootstrap генератора Mihomo. |
