...
def test_stage3_closure_is_reflected_in_documentation():
    ...
    assert "filename='panel-operator.css', v='20260728f'" in template
    for fragment in (
        "Этапы 0–3 закрыты 28 июля 2026 года; Этапы 4–7 не начаты",
    ...
    assert "Этапы 0–3 закрыты, Этапы 4–7 остаются открытыми" in index
