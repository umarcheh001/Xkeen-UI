...
def test_connections_dto_is_bounded_and_resolves_source_device():
    ...
    assert dto["connections"][0]["metadata"]["source_geoip"] == ["PRIVATE"]
    assert dto["connections"][0]["metadata"]["source_ip_asn"] == "AS64512"
    assert dto["connections"][0]["metadata"]["remote_destination"] == "198.51.100.20:443"
    assert dto["connections"][0]["metadata"]["destination_geoip"] == ["US"]
    assert dto["connections"][0]["metadata"]["destination_ip_asn"] == "AS64500"
