...
установки XKeen. Удалите диапазон из настроек стартового скрипта или выполните
чистую установку актуального XKeen, затем перезапустите XKeen и повторите
проверку. Простая смена `fake-ip-range` может создать конфликт с реальными или
локальными сетями и не является рекомендуемым исправлением.
